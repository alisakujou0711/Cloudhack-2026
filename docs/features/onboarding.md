...
| `client/src/pages/AccountSettingsPage.jsx` | The Profile card — the only other place the three fields are edited, after onboarding sets them (`docs/features/account-settings.md`) |
